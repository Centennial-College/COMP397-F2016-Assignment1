 ...
 * @version 0.2.1 - created instructions scene
 */
...
(function (scenes) {
    var Instructions = (function (_super) {
        ...
        Instructions.prototype.start = function () {
            ...
            this._instructionsButton = new objects.Button("Start", config.Screen.CENTER_X, config.Screen.CENTER_Y + 180);
            this.addChild(this._instructionsButton);
            this._instructionsButton.on("click", this._startButtonClick, this);
